...
angular.module("roarmap-h2020-view", [])
    .controller("MainController", function ($scope, $http) {
        ...
        $scope.search = function () {
            $scope.state = "Searching for: " + $scope.search_terms;
            // See: http://stackoverflow.com/a/21185103
            (function next(input, terms, index, result) {
                if (index === input.length) {
                    $scope.state = "";
                    // XXX Calling into jQuery code
                ...
                process.nextTick(function () {
                    next(input, terms, index + 1, result);
                });
            })($scope.institutions, $scope.search_terms.toLowerCase(), 0, []);
        };
        ...
        $http({
            ...
            $http({
                ...
                // XXX Glue together Angular.js and jQuery code
