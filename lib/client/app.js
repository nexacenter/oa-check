...
function getVersion() {
    jQuery.get({
        ...
        success: function (result) {
            ...
            jQuery.getJSON("/api/v1/institutions", function (result) {
                if (typeof result === "string") {
                    // TODO: understand why this must be done manually
        ...
        error: function (_, s, e) {
            jQuery("#search-result").html("<p>Failure: type=" + escapeHtml(s) + ": reason=" + escapeHtml(e) + "</p>");
        },
    });
}
